...
func TestNormalizeGLMOpenAIReasoningEffort(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			model:       "glm-5.3",
			input:       `{"model":"glm-5.3","reasoning_effort":"xhigh","messages":[]}`,
			wantApplied: true,
		...
		},
		{
			...
			model:       "GLM-5.2",
			input:       `{"model":"glm-5.3","reasoning_effort":"x-high","messages":[]}`,
			wantApplied: true,
			wantPath:    "reasoning_effort",
			wantValue:   "max",
		},
		{
			...
			model:       "glm-5.3",
			input:       `{"model":"glm-5.3","reasoning_effort":"ultracode","messages":[]}`,
			wantApplied: true,
			wantPath:    "reasoning_effort",
			wantValue:   "max",
		},
		{
			...
			model:       "glm-5.3",
			input:       `{"model":"glm-5.3","reasoning_effort":"medium","messages":[]}`,
			wantApplied: true,
			wantPath:    "reasoning_effort",
			wantValue:   "high",
		},
		{
			...
			model:       "glm-5.3",
			input:       `{"model":"glm-5.3","reasoning":{"effort":"HIGH"},"messages":[]}`,
			wantApplied: true,
		...
		},
		{
			...
			model:         "glm-5.3",
			input:         `{"model":"glm-5.3","reasoning_effort":"max","messages":[]}`,
			wantApplied:   false,
			wantUnchanged: true,
		},
		{
		...
		},
		{
			...
			model:         "glm-5.3",
			input:         `{"model":"glm-5.3","reasoning_effort":"banana","messages":[]}`,
			wantApplied:   false,
			wantUnchanged: true,
		},
	}
