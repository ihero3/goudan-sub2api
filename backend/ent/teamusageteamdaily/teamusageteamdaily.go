...
const (
	// Label holds the string label denoting the teamusageteamdaily type in the database.
	Label = "team_usage_team_daily"
	...
	EdgeTeam = "team"
	// Table holds the table name of the teamusageteamdaily in the database.
	Table = "team_usage_team_daily"
	// TeamTable is the table that holds the team relation/edge.
	TeamTable = "team_usage_team_daily"
...
// Columns holds all SQL columns for teamusageteamdaily fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the TeamUsageTeamDaily queries.
