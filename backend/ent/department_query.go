...
func (_q *DepartmentQuery) QueryTeam() *TeamQuery {
...
func (_q *DepartmentQuery) QueryMembers() *TeamMemberQuery {
...
func (_q *DepartmentQuery) QueryConsumers() *ConsumerQuery {
...
func (_q *DepartmentQuery) QueryAPIKeys() *APIKeyQuery {
...
func (_q *DepartmentQuery) QueryUsageDeptDaily() *TeamUsageDeptDailyQuery {
...
func (_q *DepartmentQuery) WithTeam(opts ...func(*TeamQuery)) *DepartmentQuery {
	query := (&TeamClient{config: _q.config}).Query()
...
func (_q *DepartmentQuery) WithMembers(opts ...func(*TeamMemberQuery)) *DepartmentQuery {
	query := (&TeamMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithConsumers(opts ...func(*ConsumerQuery)) *DepartmentQuery {
	query := (&ConsumerClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithAPIKeys(opts ...func(*APIKeyQuery)) *DepartmentQuery {
	query := (&APIKeyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) WithUsageDeptDaily(opts ...func(*TeamUsageDeptDailyQuery)) *DepartmentQuery {
	query := (&TeamUsageDeptDailyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *DepartmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Department, error) {
	...
	if query := _q.withTeam; query != nil {
		if err := _q.loadTeam(ctx, query, nodes, nil,
			func(n *Department, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMembers; query != nil {
		if err := _q.loadMembers(ctx, query, nodes,
			func(n *Department) { n.Edges.Members = []*TeamMember{} },
			func(n *Department, e *TeamMember) { n.Edges.Members = append(n.Edges.Members, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withConsumers; query != nil {
		if err := _q.loadConsumers(ctx, query, nodes,
			func(n *Department) { n.Edges.Consumers = []*Consumer{} },
			func(n *Department, e *Consumer) { n.Edges.Consumers = append(n.Edges.Consumers, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withUsageDeptDaily; query != nil {
		if err := _q.loadUsageDeptDaily(ctx, query, nodes,
			func(n *Department) { n.Edges.UsageDeptDaily = []*TeamUsageDeptDaily{} },
			func(n *Department, e *TeamUsageDeptDaily) { n.Edges.UsageDeptDaily = append(n.Edges.UsageDeptDaily, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DepartmentQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*Department, init func(*Department), assign func(*Department, *Team)) error {
...
func (_q *DepartmentQuery) loadMembers(ctx context.Context, query *TeamMemberQuery, nodes []*Department, init func(*Department), assign func(*Department, *TeamMember)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(teammember.FieldDepartmentID)
	}
...
func (_q *DepartmentQuery) loadConsumers(ctx context.Context, query *ConsumerQuery, nodes []*Department, init func(*Department), assign func(*Department, *Consumer)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(consumer.FieldDepartmentID)
	}
	query.Where(predicate.Consumer(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(department.ConsumersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DepartmentQuery) loadAPIKeys(ctx context.Context, query *APIKeyQuery, nodes []*Department, init func(*Department), assign func(*Department, *APIKey)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikey.FieldDepartmentID)
	}
...
func (_q *DepartmentQuery) loadUsageDeptDaily(ctx context.Context, query *TeamUsageDeptDailyQuery, nodes []*Department, init func(*Department), assign func(*Department, *TeamUsageDeptDaily)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Department)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(teamusagedeptdaily.FieldDepartmentID)
	}
	query.Where(predicate.TeamUsageDeptDaily(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(department.UsageDeptDailyColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *DepartmentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTeam != nil {
			_spec.Node.AddColumnOnce(department.FieldTeamID)
		}
	}
