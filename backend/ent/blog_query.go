...
func (_q *BlogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *BlogQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *BlogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *BlogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *BlogQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *BlogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
