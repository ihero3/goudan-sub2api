export default {
  ...
  enterprise: {
    ...
    solution: {
      ...
      card1Points: ['Visualized usage and transparent costs', 'Corporate transfer and compliant invoices', 'Bulk procurement saves 30%+ vs individual purchase'],
      ...
      card2Points: ['No data storage, relay, or cross-border transfer', 'Transparent models, no downgrade promised', 'Enterprise SLA guarantee (99.9%)'],
      ...
      card3Points: ['Unified API compatible with OpenAI format', 'Company pays centrally, no individual top-up', 'DeepSeek, Kimi, Glm, Minimax all in one place'],
    ...
    team: {
      ...
      feature1Points: ['Tree-based department visualization', 'Custom department codes for cost allocation', 'Department-level usage and cost tracking'],
      ...
      feature2Points: ['streamlined form for quick onboarding', 'Type-first selection for clear categorization', 'Full profile: name, email, phone, position, department'],
      ...
      feature3Points: ['Department-aware consumer filtering', 'Secure key generation and rotation', 'Per-key usage and cost attribution'],
      ...
      feature4Points: ['Usage trends: daily or hourly granularity', 'Platform distribution: see resource consumption by AI platform', 'Consumer rankings: identify top consumers', 'Cost insights: requests, tokens, and costs at a glance'],
      ...
      feature5Points: ['Admin and member role system', 'Invitation workflow with pending tracking', 'Active member statistics at a glance'],
      ...
      feature6Points: ['1-minute aggregation for near real-time insights', 'Per-consumer, per-department, per-team cost breakdowns', 'Historical trend analysis for budget planning'],
    },
    tokenManagement: {
      ...
      metrics: [
        { value: '1min', label: 'Data Aggregation', desc: 'Near real-time insights' },
        { value: '6-axis', label: 'Cost Breakdown', desc: 'Team/Dept/Consumer/Model/Key/Request' },
        { value: '100%', label: 'Cost Attribution', desc: 'Every expense traceable' },
        { value: '0-gap', label: 'Data Completeness', desc: 'No call missed' },
      ],
      features: [
        {
          icon: '🎯',
          ...
          points: ['Model-level token consumption ranking', 'Consumer-level granular usage attribution', 'Department-level cost aggregation view', 'Time-series trend analysis (daily/hourly)'],
        },
        {
          icon: '💰',
          ...
          points: ['Per-department/consumer token quota limits', 'Automatic budget overrun alerts', 'Cost trend forecasting and budget planning', 'Real-time balance and burn rate monitoring'],
        },
        {
          icon: '🔑',
          ...
          points: ['Per-key usage and cost accounting', 'Key-level quota and rate limits', 'Key lifecycle management (create/rotate/revoke)', 'Key-to-department/consumer traceability'],
        },
        {
          icon: '📊',
          ...
          points: ['Near real-time usage data refresh', 'Multi-dimensional cross-analysis panels', 'Exportable customized reports', 'API call trend visualization charts'],
        },
        {
          icon: '🛡️',
          ...
          points: ['Full call log traceability', 'Data processing activity records (GDPR compatible)', 'Automated audit report generation', 'End-to-end operation behavior tracking'],
        },
        {
          icon: '⚡',
          ...
          points: ['High-frequency low-efficiency call detection', 'Model selection optimization suggestions', 'Idle resource reclamation reminders', 'Real-time cost saving opportunity alerts'],
        },
      ],
      processTitle: 'Four-Step Token Management',
      processSteps: [
        { title: 'Set Budgets & Quotas', desc: 'Allocate token budgets and usage quotas by department and consumer' },
        { title: 'Real-Time Monitoring', desc: '1-minute aggregation with full-dimension usage and cost monitoring' },
        { title: 'Alerts & Optimization', desc: 'Overrun alerts, anomaly detection, automated optimization suggestions' },
        { title: 'Audit & Review', desc: 'Generate audit reports, review AI ROI' },
      ],
    },
    teamWorkflow: {
      label: 'Quick Start',
      ...
      step1Points: ['One-click team space creation', 'Granular member permission management', 'Flexible usage quota configuration'],
      ...
      step2Points: ['One-click invitation link generation', 'Team members join and use instantly', 'Unified billing and auditing'],
      ...
      step3Points: ['Flexible member management', 'Real-time usage monitoring', 'Differentiated quota allocation'],
    },
    compare: {
      ...
      rows: {
        entity: { label: 'Operator', us: 'Official company operation', them: 'Often unregistered individual operations' },
        security: { label: 'Data Security', us: 'No conversation storage, end-to-end encryption', them: 'Can record and resell data' },
        transparency: { label: 'Model Transparency', us: 'Transparent and traceable', them: 'May downgrade models, unverifiable' },
        sla: { label: 'SLA Guarantee', us: '99.9% uptime with SLA', them: 'No SLA, may shut down anytime' },
        invoice: { label: 'Invoice', us: 'Compliant invoices, corporate transfer', them: 'Usually no invoice capability' },
        support: { label: 'Support', us: 'Professional team, dedicated contact', them: 'Essentially zero' },
        price: { label: 'Price', us: 'Market-reasonable pricing', them: 'Extremely low even 90% off' },
      },
    },
    employeeApply: {
      label: 'Bottom-Up',
      ...
      benefits: [
        { title: 'Why Should Your Boss Approve?', desc: 'ThreeRouter is an official product, secure, compliant, and reliable. The spend is an investment in team efficiency, not personal consumption.' },
        { title: 'How Much Can It Improve?', desc: 'After adopting AI APIs, code generation, debugging, and documentation writing can become 5-10x more efficient. Interns can deliver high-quality output.' },
        { title: 'Fully Compliant, Finance Worry-Free', desc: 'Supports corporate transfer and compliant invoices. No hidden corners, fully OK for finance audits.' },
        { title: 'One Person Applies, Whole Team Benefits', desc: 'Once the company enables it, the entire tech team can use the best AI models. One person drives, whole team upgrades.' },
      ],
    ...
    // Reuse home.footer translation keys
  },
}
