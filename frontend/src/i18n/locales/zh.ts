export default {
  ...
  enterprise: {
    ...
    solution: {
      ...
      card1Points: ['用量可视化，成本透明可控', '对公转账、合规发票', '批量采购比个人购买节省 30%+'],
      card1Btn: '预约方案演示',
      card2Badge: '成本透明省 30%',
      card2Title: '安全合规，数据零风险',
      card2Desc: '选择合规、透明、可审计的 API 接入路径，让安全风险不再困扰。',
      card2Points: ['数据不存储、不中转、不出境', '模型透明，承诺不偷换', '企业级 SLA 保障（99.9%）'],
      card2Btn: '查看技术文档',
      card2BtnLink: '/help-cn.html',
      card3Badge: '统一 API 提效',
      card3Title: '一人申请，全团队用上顶级模型',
      card3Desc: '推荐公司接入，统一 API 网关，一行代码切换模型，开发效率起飞。',
      card3Points: ['统一 API 接口，兼容 OpenAI 格式', '公司统一付费，不用个人充值', 'DeepSeek、Kimi、Glm、Minimax 一网打尽'],
      card3Btn: '推荐给公司',
    },
    team: {
      label: '团队管理',
    ...
    tokenManagement: {
      ...
      metrics: [
        { value: '1min', label: '数据聚合粒度', desc: '近实时用量洞察' },
        { value: '6维度', label: '成本拆解维度', desc: '团队/部门/消费者/模型/密钥/请求' },
        { value: '100%', label: '成本归因覆盖率', desc: '每笔费用可追溯' },
        { value: '0漏报', label: '用量数据完整性', desc: '不遗漏任何调用' },
      ],
      features: [
        {
          icon: '🎯',
          ...
          points: ['模型级 Token 消耗排行', '消费者级别的精细用量归因', '部门维度的成本聚合视图', '时间序列趋势分析（天/小时）'],
        },
        {
          icon: '💰',
          ...
          points: ['按部门/消费者设置 Token 配额上限', '预算超限自动告警通知', '成本趋势预测与预算规划', '实时余额与消耗速率监控'],
        },
        {
          icon: '🔑',
          ...
          points: ['单密钥用量与成本独立核算', '密钥级别配额与速率限制', '密钥生命周期管理（创建/轮换/停用）', '密钥关联部门与消费者追溯'],
        },
        {
          icon: '📊',
          ...
          points: ['近实时用量数据刷新', '多维度交叉分析面板', '可导出的定制化报表', 'API 调用趋势可视化图表'],
        },
        {
          icon: '🛡️',
          ...
          points: ['全量调用日志可追溯', '数据处理活动记录（GDPR 兼容）', '审计报告自动生成', '操作行为全程留痕'],
        },
        {
          icon: '⚡',
          ...
          points: ['高频低效调用自动识别', '模型选择优化建议', '闲置资源回收提醒', '成本节省机会实时推送'],
        },
      ],
      processTitle: 'Token 精细化管理四步法',
      processSteps: [
        { title: '设定预算配额', desc: '按部门和消费者分配 Token 预算与使用配额' },
        { title: '实时监控追踪', desc: '1 分钟级数据聚合，全维度监控用量与成本' },
        { title: '告警与优化', desc: '超限告警、异常检测、自动推送优化建议' },
        { title: '审计与复盘', desc: '生成审计报告，复盘 AI 投入产出比' },
      ],
    },
    teamWorkflow: {
      label: '快速上手',
      ...
      step1Points: ['一键创建团队空间', '精细化成员权限管理', '用量配额灵活配置'],
      step2Title: '邀请加入团队',
      step2Desc: '管理员一键生成邀请链接，团队成员点击即可加入。无需繁琐注册，统一团队计费与审计。',
      step2Points: ['一键生成邀请链接', '团队成员即点即用', '统一计费与审计'],
      step3Title: '成员与配额管控',
      step3Desc: '添加或移除团队成员，按角色分配访问权限。实时监控用量，设置差异化配额，合理分配资源。',
      step3Points: ['灵活成员管理', '实时用量监控', '差异化配额分配'],
    },
    compare: {
      label: '透明对比',
      ...
      them: '普通中转站',
      rows: {
        entity: { label: '运营实体', us: '正规公司运营', them: '多无工商注册，个人小作坊' },
        security: { label: '数据安全', us: '不存储对话数据，端到端加密', them: '可完整记录并转卖数据' },
        transparency: { label: '模型透明性', us: '透明运行，源头可追溯', them: '可偷换降级模型，无法验证' },
        sla: { label: 'SLA 保障', us: '99.9% 可用性，有 SLA 承诺', them: '无 SLA，随时跑路' },
        invoice: { label: '发票支持', us: '合规发票，对公转账', them: '大多无发票能力' },
        support: { label: '售后支持', us: '专业团队，专人对接', them: '基本为零' },
        price: { label: '价格', us: '市场合理价位', them: '极低价甚至 1 折' },
      },
    },
    employeeApply: {
      label: '自下而上',
      ...
      benefits: [
        { title: '老板为什么应该批？', desc: 'ThreeRouter 是官方出品，安全合规、品牌可靠。花的钱是团队效率投资，不是个人消费。' },
        { title: '用了能提升多少？', desc: '接入 AI API 后，代码生成、调试、文档编写效率可提升 5-10 倍。实习生也能产出高质量代码。' },
        { title: '完全合规，财务无忧', desc: '支持对公转账、可开合规发票。不偷偷摸摸，财务审计也完全 OK。' },
        { title: '一个人申请，全团队受益', desc: '一旦公司开通，整个技术团队都能用上最好的 AI 模型。你一个人推动，带动团队升级。' },
      ],
