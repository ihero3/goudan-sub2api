        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <div>
                <label class="input-label">
                  {{ t('admin.settings.features.affiliate.registerReward') }}
                </label>
                <input
                  v-model.number="form.affiliate_register_reward"
                  type="number"
                  step="0.01"
                  min="0"
                  max="100"
                ...
                />
                <p class="mt-1 text-xs text-gray-400">
                  {{ t('admin.settings.features.affiliate.registerRewardDesc') }}
                </p>
              </div>
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      affiliate_register_reward: Math.max(0, Math.min(100, Number(form.affiliate_register_reward) || 0)),
